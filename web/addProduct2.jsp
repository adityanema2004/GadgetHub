      ...
      <div class="row justify-content-center">
        <form action="" class="col-md-6 myform">
          ...
          <div class="form-group mt-3">
            <label for="product_duct">Product Description</label>
            <textarea name="" id="product_duct" class="form-control"></textarea>
          </div>
          <div class="row mt-3">
            <div class="col-md-6 form-group">
          ...
          <div class="form-group mt-3">
            <label for="images/product_img">Product Image</label>
