                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6 form-group"> 
                            ...
                            <select name="type" id="producttype" class="form-control" required> 
                                ...
                                <option value="camera" <%=ptype.equalsIgnoreCase("tv") ? "selected" : ""%>>TV</option> 
                                ...
                                <option value="book" <%=ptype.equalsIgnoreCase("book") ? "selected" : ""%>>BOOK</option> 
                                <option value="pen" <%=ptype.equalsIgnoreCase("pen") ? "selected" : ""%>>PEN</option> 
                                <option value="pandrive" <%=ptype.equalsIgnoreCase("pandrive") ? "selected" : ""%>>PAN DRIVE</option> 
                                <option value="copy" <%=ptype.equalsIgnoreCase("copy") ? "selected" : ""%>>COPY</option> 
                                <option value="trollybag" <%=ptype.equalsIgnoreCase("trollybag") ? "selected" : ""%>>TROLLY BAG</option> 
                                <option value="bag" <%=ptype.equalsIgnoreCase("bag") ? "selected" : ""%>>BAG</option> 
