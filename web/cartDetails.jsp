            ...
            <table class="table table-hover"> 
                ...
                <tbody> 
                    <%
                        ...
                        List<UsercartPojo> cartItems = (List<UsercartPojo>) request.getAttribute("cartItems");
                        Map<String, Object> map = (Map<String, Object>) request.getAttribute("map");
                        double totalAmount = 0.0;
                        for (UsercartPojo item : cartItems) {
                    ...
                    <tr> 
                        <td><img src="./ShowImageServlet?pid=<%=product.getProdId()%>"style="width: 50px; height: 50px;"></td> 
                        <%
                            String productName = product.getProdName();
                            productName = productName.substring(0, Math.min(70, productName.length()));
                        %>
                        <td><%=productName%></td> 
