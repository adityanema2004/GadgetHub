    ...
    <body>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu"> 
                            ...
                            <li>
                                <a href="#" class="nav-link">Speaker</a>
                            </li>
                            <li>
                                <a href="#" class="nav-link">Cooler</a>
                            </li>
                            <li>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu"> 
                                ...
                                <li>
                                    <a href="#" class="nav-link">Remove Product</a>
                                </li>
                                <li>
        ...
        <!-- admin navbar ends here -->
         ...
         <!-- Customer Navbar starts here -->
          <nav class="navbar navbar-expand-lg navbar-custom">
            <div class="container-fluid"><a href="userHome.jsp" class="navbar-brand">
                GadgetHub
            </a>
            <button type="button" class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#mynav">
                <span class="navbar-toggler-icon"></span>
