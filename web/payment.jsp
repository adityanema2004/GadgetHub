    ...
    <body style="background-color: #E6F9E6;">
        ...
        <%
            ...
            if (userName == null || password == null) {
                response.sendRedirect("login.jsp?message=Session expired ! Please login as admin");
            }
                ...
                <form action="./OrderServlet" method="post"
                    ...
                    <div class="text-center mt-3">
                        <div class="form-group">
                            <img src="images/payment.png" alt="payment_image" height="100px" width="100px" class="rounded-pill"/>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="last_name">Expiry Year</label> <input type="number"placeholder="YYYY" class="form-control" size="4" id="last_name"min="<%=year%>"name="expyear" required>
                        </div>
                    </div>
                    <div class="row mt-3 mb-3">
                        <div class="col-md-6 form-group">
                            <label for="last_name">Enter CVV</label> 
                            <input type="number"placeholder="123" class="form-control" size="3" id="last_name"name="expyear" required> 
