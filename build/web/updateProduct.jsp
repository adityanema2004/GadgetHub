...
<input type="number" value="<%=product.getProdQuantitiy() %>" placeholder="Enter Stock Quantity" class="form-control" id="last_name" name="quantity" required> 
</div> 
</div> 
<br/> 
...
<button type="submit" formaction="./AdminViewtServlet" class="btn btn-danger">Cancel</button> 
</form> 
</div> 
