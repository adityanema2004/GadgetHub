...
public class AddToCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        pQty += cartQty;
        if (action != null) {
            cartDao.updateProductInCart(new UsercartPojo(userId, prodId, pQty));
            ...
            if (avQty == 0) {
                ...
                cartDao.updateProductInCart(new UsercartPojo(userId, prodId, avQty));
            ...
            String status = cartDao.updateProductInCart(new UsercartPojo(userId, prodId, pQty));
            List<ProductPojo> products = productDao.getAllProducts();
            Map<String, Integer> map = new HashMap<>();
            for (ProductPojo product : products) {
                int qty = cartDao.getCartItemCount(userName, product.getProdId());
